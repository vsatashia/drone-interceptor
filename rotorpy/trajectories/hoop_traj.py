...
class HoopTraj(object):
    ...
    def update(self, t, target, lookahead_t, v_avg):
        """
        ...
        v2 = target[3:6]
        pt2 = target[0:3] + v2 * lookahead_t  # interpolate for specified time horizon

        self.traj = Polynomial(points=np.array([pt1, pt2]), v_avg=v_avg)
